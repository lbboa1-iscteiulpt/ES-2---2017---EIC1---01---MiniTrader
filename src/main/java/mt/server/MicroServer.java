	...
	private boolean saveOrder(Order o) {
		...
		if(o.getNumberOfUnits()>=10){
			...
			for(Order orderInList : orders){
				...
				if(o.getStock().equals(orderInList.getStock()) && o.isBuyOrder() != orderInList.isBuyOrder()){
					serverComm.sendError(o.getNickname(), "You can't to issue sell orders for your own buy orders and vice versa");
					return false;
				}
			}
